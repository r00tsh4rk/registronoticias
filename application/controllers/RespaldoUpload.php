   ...
   public function SubirInfo()
	{
        ...
        if (!empty($_FILES['imagenMiniatura']['name']))
        {
           ...
           $hora_actual =  date("H:i:s");
        	...
        	$agregar= $this->Model_upload->insertar($titulo_miniatura, $descripcion, $cuerpo_noticia, $fecha_actual, $hora_actual, $quien_publica, $newimgminiatura, $nweslider);
