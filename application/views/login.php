  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
      ...
      <a style="color:#ffffff;" class="navbar-brand" href="#">Sistema de Publicación de Noticias / Login</a>
    </div>
  </nav>
...
<div class="container">
  <div class="row">
    <div class="col-sm-6 col-md-4 col-md-offset-4">
		...
		<div align="center">
			<h1 style="color: white;" class="text-center login-title">Bienvenid@s</h1>
		</div>
