    ...
    <!--[if lt IE 9]>
      ...
      <body>
        ...
        <div class="container">
         ...
         <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header">Catálogo de Noticias
            </h1>
            <ol class="breadcrumb">
              <li><a href="../index.html">Inicio</a>
              </li>
              <li class="active">Catálogo de Noticias</li>
            </ol>
          </div>
        </div>
        <!-- /.row -->
             ...
             <?php foreach ($noticias as $row) {
               ...
               <div class="row">
                ...
                <div class="col-md-6 portfolio-item">
                  <a href="#">
                    <img style="height: 250px; width: 450px;" src="<?php echo base_url().'resourcesimg/'.$row->imagenMiniatura; ?>"/>
                  </a>
                  <h3>
